...
export default function DashboardClient() {
  ...
  const totalExecutions = dashboard?.totalTests ?? 0;
    ...
    <div>
      ...
      >
        <StatCard
          ...
          accent="#0B3D2E"
          trend={{ direction: "up", label: "Uses current execution data" }}
          icon={
        ...
        <StatCard
          ...
          value={failedCount}
          accent="#DC2626"
          trend={{ direction: "up", label: "Current failed execution count" }}
          icon={
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="square">
